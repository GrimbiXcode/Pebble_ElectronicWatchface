/********************************************************************
* Project:          Simple Electronic Watchface
* Description:      Simple Watchface with a nice Background
* Developer:        GrimbiXcode (David Grimbichler)
* File:             main.c
* First Release:    2015-07-29
********************************************************************/
...
static void main_window_load(Window *window){
  ...
  //text_layer_set_font(s_battery_layer, fonts_get_system_font(FONT_12));
  text_layer_set_text_alignment(s_time_layer, GTextAlignmentCenter);
